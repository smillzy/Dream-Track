...
public class AssetsRepositoryImpl implements AssetsRepository {
    ...
    @Override
    public List<Map<String, Object>> findAllAssetsCurrentDeposit(Long userId) {
    ...
    @Override
    public List<Map<String, Object>> findAllAssetsForeignCurrencies(Long userId) {
        String selectSql = """
    ...
    @Override
    public List<Map<String, Object>> findAllAssetsStock(Long userId) {
        String selectSql = """
