...
public class ExpensesController {
    ...
    @GetMapping("/single")
    public ResponseEntity<?> GetAccountingSingle(@RequestParam(name = "user-id") Long userId,
    ...
    @GetMapping("/interval")
    public ResponseEntity<?> GetAccounting(@RequestParam(name = "user-id") Long userId,
